    ...
    <div className="pt-16">
      ...
      <section className="gradient-bg text-white section-padding">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          {/* Billing Toggle */}
          <div className="inline-flex items-center bg-white bg-opacity-20 rounded-lg p-1">
            <button
              onClick={() => setIsAnnual(false)}
              className={`px-4 py-2 rounded-md text-sm font-medium transition-all duration-200 ${
                !isAnnual ? 'bg-white text-primary-600' : 'text-white'
              }`}
            >
              Monthly
            </button>
            ...
            >
              Annual
              <span className="ml-1 text-xs bg-yellow-400 text-yellow-900 px-2 py-1 rounded-full">
                Save 20%
              </span>
            </button>
          </div>
